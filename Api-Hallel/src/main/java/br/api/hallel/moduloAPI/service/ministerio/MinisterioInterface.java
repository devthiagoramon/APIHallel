...
public interface MinisterioInterface {
    ...
    public MinisterioResponse createMinisterio(MinisterioDTO ministerioDTO);
    public MinisterioResponse editMinisterio(String idMinisterio, MinisterioDTO ministerioDTO);
